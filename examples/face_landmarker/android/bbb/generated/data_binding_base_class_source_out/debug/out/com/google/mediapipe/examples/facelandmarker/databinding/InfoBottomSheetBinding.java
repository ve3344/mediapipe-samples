...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatImageButton maxFacesMinus;

  @NonNull
  public final AppCompatImageButton maxFacesPlus;

  @NonNull
  public final TextView maxFacesValue;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull TextView inferenceTimeVal, @NonNull AppCompatImageButton maxFacesMinus,
      @NonNull AppCompatImageButton maxFacesPlus, @NonNull TextView maxFacesValue,
      @NonNull AppCompatImageButton presenceThresholdMinus,
    ...
    this.maxFacesMinus = maxFacesMinus;
    this.maxFacesPlus = maxFacesPlus;
    this.maxFacesValue = maxFacesValue;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.max_faces_minus;
      AppCompatImageButton maxFacesMinus = ViewBindings.findChildViewById(rootView, id);
      if (maxFacesMinus == null) {
        break missingId;
      }

      id = R.id.max_faces_plus;
      AppCompatImageButton maxFacesPlus = ViewBindings.findChildViewById(rootView, id);
      if (maxFacesPlus == null) {
        break missingId;
      }

      id = R.id.max_faces_value;
      TextView maxFacesValue = ViewBindings.findChildViewById(rootView, id);
      if (maxFacesValue == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          ...
          inferenceTimeLabel, inferenceTimeVal, maxFacesMinus, maxFacesPlus, maxFacesValue,
          presenceThresholdMinus, presenceThresholdPlus, presenceThresholdValue, spinnerDelegate,
          trackingThresholdMinus, trackingThresholdPlus, trackingThresholdValue);
    }
